...
- 假设医疗手术的时候，会给大脑传输植入一些关键字眼，在生活中通过他人的言辞开启意识减弱状态，进入迷茫思考，行动也迷茫后的自主，加上脑海脑海里的声音就会产生一系列的行为，行为是什么不重要，重要的是利用这个行为，而且一定是了解关键字眼的人才知道怎么利用：
...
5 假设世界分为4个层面，1，在梦境层面前面  2 梦境层面   3现实层面   4 数据层面，，我曾假设我进入了D环境，在这里物质是可以复原的，然后有进入了，切换的时候是通过社会性决定的，开始的直接元婴是被蛊惑造成的。
